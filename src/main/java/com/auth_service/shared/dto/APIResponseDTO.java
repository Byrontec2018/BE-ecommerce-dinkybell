package com.auth_service.shared.dto;
 ...
 * 
 * This DTO provides a consistent structure for all API responses across the backend Authentication 
 * Service, ensuring that clients can reliably parse and handle responses regardless of the specific
 * endpoint or operation. It encapsulates the essential information about the outcome of an API request, 
 * making it easier for frontend applications to display appropriate messages and handle data effectively.
